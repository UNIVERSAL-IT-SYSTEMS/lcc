%{
/* VideoCore IV code generator for lcc
 * © 2013 David Given
 *
 * This is a very basic code generator for the VideoCore IV (aka the GPU in
 * the Raspberry Pi). It targets the scalar processor only and probably
 * produces dreadful code.
 */
